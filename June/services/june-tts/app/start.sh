...
echo "   Coqui TOS accepted: ${COQUI_TOS_AGREED:-1}"
...
echo ""
echo "=== License ==="
echo "   Coqui TTS uses CPML (Coqui Public Model License)"
echo "   Commercial use requires a commercial license from Coqui"
echo "   Non-commercial use is free under CPML terms"
echo "   By using this service, you agree to Coqui's terms: https://coqui.ai/cpml"
echo ""
