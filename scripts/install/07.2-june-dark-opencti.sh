...
warn "Images needed:"
warn "  - ozzuworld/june-dark-orchestrator:latest"
warn "  - ozzuworld/june-dark-collector:latest"
warn "  - ozzuworld/june-dark-enricher:latest"
warn "  - ozzuworld/june-dark-ops-ui:latest"
warn "  - ozzuworld/june-dark-opencti-connector:latest"
warn ""
